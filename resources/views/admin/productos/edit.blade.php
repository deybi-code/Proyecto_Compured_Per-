...
@section('title', 'Editar Producto – Admin Compured Perú')
@section('content')
<div style="max-width:760px">
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px">
        ...
        <h1 style="font-family:'Rajdhani',sans-serif;font-size:1.5rem;font-weight:800;color:#172B4D" class="dark:text-white">Editar Producto</h1>
    </div>
