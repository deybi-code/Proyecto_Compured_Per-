...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px">
    <div>
        ...
        <p style="font-size:0.82rem;color:#97A0AF;margin-top:2px">{{ isset($productos) ? (method_exists($productos, 'total') ? $productos->total() : $productos->count()) : 0 }} productos registrados</p>
    </div>
