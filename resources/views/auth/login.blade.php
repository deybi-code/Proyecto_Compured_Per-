    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50">
        <div class="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border-t-4 border-[#0056b3]">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-sm text-gray-500">Tecnología Informática a tu Alcance</p>
            </div>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('register') }}" class="text-[#8cc63f] font-semibold hover:underline">¿No tienes cuenta? Regístrate</a>
            </div>
        </div>
    </div>
</x-guest-layout>
