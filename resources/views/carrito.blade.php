...
<style>
    ...
    /* ===== Hero compacto (fondo, grid, partículas) ===== */
    .hero-scene {
    ...
    /* ===== Panel premium (reemplaza a las cabeceras planas) ===== */
    .premium-panel {
    ...
    .premium-panel-body { padding: 26px; }
    ...
    .checkout-steps .step { display:flex; align-items:center; gap:10px; }
    ...
    .checkout-steps .step .label { font-size:12px; font-weight:800; color:var(--text); text-transform:uppercase; letter-spacing:.4px; }
    ...
    .checkout-steps .line { width:36px; height:2px; background: linear-gradient(90deg, var(--primary), var(--border)); border-radius:2px; }
    ...
    .checkout-title .step-badge {
        ...
        font-size:11px; font-weight:900; flex-shrink:0; box-shadow:0 4px 10px rgba(29,78,216,0.35);
    }
...
<div class="max-w-7xl mx-auto px-4 pb-16" style="min-height: calc(100vh - 320px);">
    ...
    <div class="checkout-steps animate-card">
        <div class="step"><div class="dot">1</div><div class="label">Carrito<small>Tus productos</small></div></div>
        <div class="line"></div>
        <div class="step"><div class="dot">2</div><div class="label">Datos y Entrega<small>Comprobante y envío</small></div></div>
        <div class="line"></div>
        <div class="step"><div class="dot">3</div><div class="label">Pago<small>Confirmar pedido</small></div></div>
    </div>
    ...
    <div class="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div style="flex:1; width:100%;" class="animate-card" style="animation-delay: 0.15s;">
            ...
            <form id="formPago" action="{{ route('pago.procesar') }}" method="POST" x-data="{
                tipo_doc: 'dni',
                entrega: 'delivery',
                metodo_pago: 'tarjeta'
            }">
                ...
                <div class="premium-panel mb-6" id="panel-pago">
                    ...
                    <div class="checkout-section">
                        ...
                        <div x-show="metodo_pago === 'transferencia'" x-transition.opacity style="display:none; background:rgba(59,130,246,0.08); border:1px solid rgba(59,130,246,0.2); padding:14px 16px; border-radius:14px; margin-top:2px; margin-bottom:10px;">
