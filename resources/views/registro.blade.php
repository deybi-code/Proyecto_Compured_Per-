...
.shadow-\[0px_0px_1px_0px_rgba\(0\,0\,0\,0\.03\)\,0px_1px_2px_0px_rgba\(0\,0\,0\,0\.06\)\] {
  --tw-shadow: 0px 0px 1px 0px rgba(0, 0, 0, 0.03),
...
.hover\:bg-\[\#004494\]:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(0 68 148 / var(--tw-bg-opacity, 1));
}
...
@media (prefers-color-scheme: dark) {
  ...
  .dark\:active\:text-gray-300:active {
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 transition-colors duration-300" id="main-container">
        <div class="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl border-t-4 border-[#0056b3]">

            <div class="flex justify-end mb-2">
                <button onclick="toggleTheme()" class="text-sm px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:opacity-80">
                    🌓 Cambiar tema
                </button>
            </div>
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Regístrate para continuar</p>
            </div>

            <form method="POST" action="{{ route('register') }}">
                @csrf
                <div class="mb-4">
                    <label class="block text-gray-700 dark:text-gray-300 font-medium">Nombre</label>
                    <input type="text" name="name" class="w-full mt-2 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white outline-none" required>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 dark:text-gray-300 font-medium">Correo Electrónico</label>
                    <input type="email" name="email" class="w-full mt-2 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white outline-none" required>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 dark:text-gray-300 font-medium">Contraseña</label>
                    <input type="password" name="password" class="w-full mt-2 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white outline-none" required>
                </div>
                <div class="mb-6">
                    <label class="block text-gray-700 dark:text-gray-300 font-medium">Confirmar Contraseña</label>
                    <input type="password" name="password_confirmation" class="w-full mt-2 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white outline-none" required>
                </div>

                <button type="submit" class="w-full bg-[#0056b3] text-white p-3 rounded-lg font-bold hover:bg-[#004494]">Registrarse</button>
            </form>
        </div>
    </div>
